...
/**
 * @brief A basic @ref qpl_op_extract operation based on accelerator configuration
 */
QPL_LOW_LEVEL_API_BAD_ARGUMENT_TEST(extract, max_transfer_size) {
    ...
    set_operation_properties(job_ptr, DROP_INITIAL_BYTES, OPERATION_FLAGS, qpl_op_extract);

 ...
 */
int qpl_isal_create_hufftables(struct isal_hufftables* hufftables, struct isal_huff_histogram* histogram);
 ...
 * @returns Returns a non zero value if an invalid huffman code was created.
 */
int qpl_isal_create_hufftables_subset(struct isal_hufftables* hufftables, struct isal_huff_histogram* histogram);
 ...
 * @returns Ret
 */
int qpl_isal_create_hufftables_literals_only(struct isal_hufftables* hufftables, struct isal_huff_histogram* histogram);
#endif
 ...
 */
int qpl_isal_deflate_set_hufftables(struct isal_zstream* stream, struct isal_hufftables* hufftables, int type);
 ...
 */
int qpl_isal_deflate_process_dict(struct isal_zstream* stream, struct isal_dict* dict_str, uint8_t* dict,
                                  uint32_t dict_len);

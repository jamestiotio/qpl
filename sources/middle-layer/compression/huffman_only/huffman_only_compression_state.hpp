...
#ifndef QPL_SOURCES_MIDDLE_LAYER_COMPRESSION_HUFFMAN_ONLY_HUFFMAN_ONLY_COMPRESSION_STATE_HPP
#define QPL_SOURCES_MIDDLE_LAYER_COMPRESSION_HUFFMAN_ONLY_HUFFMAN_ONLY_COMPRESSION_STATE_HPP
...
public:
    ...
    [[nodiscard]] inline auto endianness() noexcept -> endianness_t { return endianness_; }

    [[nodiscard]] inline auto checksum() noexcept -> util::checksum_accumulator& { return checksum_; }
...
private:
    ...
    friend void update_state(huffman_only_state<execution_path_t::software>& stream, uint8_t* start_in_ptr,
    ...
    friend auto compress_huffman_only(uint8_t* begin, const uint32_t size, stream_t& stream) noexcept
...
#endif //QPL_SOURCES_MIDDLE_LAYER_COMPRESSION_HUFFMAN_ONLY_HUFFMAN_ONLY_COMPRESSION_STATE_HPP

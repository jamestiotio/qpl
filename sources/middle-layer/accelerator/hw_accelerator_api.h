 ...
 */
HW_PATH_GENERAL_API(hw_accelerator_status, accelerator_submit_descriptor,
                    (hw_accelerator_context* const accel_context_ptr, const hw_descriptor* const descriptor_ptr,

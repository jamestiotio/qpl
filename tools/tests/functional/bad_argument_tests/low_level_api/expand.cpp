...
/**
 * @brief A basic @ref qpl_op_expand operation based on accelerator configuration
 */
QPL_LOW_LEVEL_API_BAD_ARGUMENT_TEST(expand, max_transfer_size) {
    QPL_SKIP_TEST_FOR(qpl_path_software);
    ...
    set_operation_properties(job_ptr, DROP_INITIAL_BYTES, OPERATION_FLAGS, qpl_op_expand);

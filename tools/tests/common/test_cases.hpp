...
public:
    /**
        ...
        */
    TestCase GetTestCase() { return *current_test_case_it; }
...
protected:
    ...
    /**
        ...
        */
    uint32_t TestCaseCount() { return static_cast<uint32_t>(test_cases.size()); }

    void SetSpecifiedTestCase(uint32_t test_case_id) { current_test_case_it = test_cases.begin() + test_case_id; }
...
/**
    ...
    */
template <class TestCase>
class ReferenceFixtureWithTestCases
...
#define QPL_TEST_TC_(test_suite_name, test_name, parent_class, parent_id)                                          \
    ...
    public:                                                                                                        \
        ...
        (const GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) &&) = delete;                                    \
        GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) &                                                       \
        operator=(const GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) &) = delete;                            \
        GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) &                                                       \
        operator=(const GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) &&) = delete;                           \
                                                                                                                   \
    private:                                                                                                       \

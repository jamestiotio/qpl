...
#ifndef QPL_TOOLS_TESTS_COMMON_ANALYTIC_MASK_FIXTURE_HPP
#define QPL_TOOLS_TESTS_COMMON_ANALYTIC_MASK_FIXTURE_HPP
...
#endif //QPL_TOOLS_TESTS_COMMON_ANALYTIC_MASK_FIXTURE_HPP

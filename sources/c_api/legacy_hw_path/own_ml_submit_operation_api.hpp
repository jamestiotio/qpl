...
qpl_status hw_descriptor_compress_init_deflate_dynamic(hw_decompress_analytics_descriptor* desc_ptr,
...
/* ====== Decompress ====== */
qpl_status hw_submit_decompress_job(qpl_job* qpl_job_ptr, uint32_t last_job, uint8_t* next_in_ptr,
...
qpl_status hw_descriptor_decompress_init_inflate_body(hw_descriptor* const descriptor_ptr, uint8_t** const data_ptr,
                                                      uint32_t* const data_size, uint8_t* out_ptr, uint32_t out_size,
                                                      const uint8_t ignore_start_bit, const uint8_t ignore_end_bit,
                                                      const uint32_t crc_seed, hw_iaa_aecs* const state_ptr);
